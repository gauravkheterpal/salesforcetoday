...
class STMeetingTasksViewController: UITableViewController, SFRestDelegate {
    ...
    */
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let refreshButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.refresh, target: self, action: #selector(STMeetingTasksViewController.showTasks))
    ...
    */
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: STMeetingTaskTableViewCellId) as! STTaskListCell
        let task = self.meetingTasks[(indexPath as NSIndexPath).row]
...
//        UIApplication.shared().openURL(url!)
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let headerCell = tableView.dequeueReusableCell(withIdentifier: "MeetingSectionHeader")
        return headerCell
    }
